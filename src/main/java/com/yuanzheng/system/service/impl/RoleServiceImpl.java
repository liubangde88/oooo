...
import com.yuanzheng.system.dao.RoleDao;
import com.yuanzheng.system.dao.RoleMenuDao;
...
import com.yuanzheng.system.domain.RoleMenuDO;
...
public class RoleServiceImpl implements RoleService {
    ...
    public List<RoleDO> list() {
        ...
        List<RoleDO> roles = roleMapper.list(query);
        return roles;
    }
    ...
    public int save(RoleDO role) {
        role.setDeptId(ShiroUtils.getUser().getDeptId());
