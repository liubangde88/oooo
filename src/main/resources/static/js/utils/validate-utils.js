...
(function (window, $, undefined) {
    ...
    coreUtil.call = function (code, millisec) {
        if (coreUtil.isString(code) && coreString.isNullOrWhiteSpace(code)) {
            return;
        }
    ...
    coreString.replaceAll = function (str, substr, replacement, ignoreCase) {
        if (!substr || !replacement || substr == replacement) {
            return str;
        }
    ...
    coreString.prototype.isSimpleSafePwd = function () {
        return coreString.isSimpleSafePwd(this);
    };
    ...
    coreString.prototype.isControllerId = function () {
        return coreString.isControllerId(this);
    };
    ...
    coreString.toObject = function (str) {
    ...
    coreString.prototype.toArray = function (splitStr) {
        return coreString.toArray(this, splitStr);
    };
    ...
    //  判断对象是否是一个数组
    coreArray.isArray = core_isArray ? core_isArray : function (array) {
        return coreUtil.type(array) === "array";
    };
    ...
    coreArray.push = function (array, item) {
        if (!coreArray.likeArray(array)) {
            throw "传入的参数 array 不是一个数组对象。";
        }
        return core_push.call(array, item);
    };
    coreArray.prototype.push = function (item) {
        return coreArray.push(this, item);
    };
    ...
    coreArray.prototype.copy = function (source) {
        return coreArray.copy(source, this);
    };
    coreArray.prototype.copyTo = function (target) {
        return coreArray.copy(this, target);
    };
    ...
    coreArray.prototype.sort = function (callback) {
        return coreArray.sort(this, callback);
    };
    ...
    coreArray.left = function (array, length) {
        array = coreArray.likeArray(array) ? array : [];
        if (!length || !$.isNumeric(length) || length < 0) {
            return [];
        }
    ...
    coreDate.isDate = function (date) {
        return coreUtil.isDate(date) || coreString.isDate(date) || new Date(date) != 'NaN';
    };
    ...
    coreJquery.shine = function (selector, interval, times) {
        ...
        if (!coreUtil.isNumeric(interval) || interval <= 40) {
            interval = coreJquery.shineInterval;
        }
        if (!coreUtil.isNumeric(times) || times < 4) {
            times = coreJquery.shineTimes;
        }
        var a = function () {
            selector.addClass("vt-shine");
        };
        var b = function () {
            selector.removeClass("vt-shine");
        };
        var run = function () {
    ...
    if (_enableUniqueID) {
        $(function () {
            if (!coreUtil.isTopMost && coreUtil.currentFrame && coreUtil.currentFrame != null) {
