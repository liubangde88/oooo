package com.yuanzheng.oa.controller;
...
import com.yuanzheng.oa.domain.NotifyRecordDO;
import com.yuanzheng.oa.service.NotifyRecordService;
...
public class NotifyController extends BaseController {
    ...
    @GetMapping("/processResult/{id}")
    String processResult(@PathVariable("id") Long id, Model model) {
        NotifyDO notify = notifyService.get(id);
        model.addAttribute("notify", notify);
        return "oa/notify/processResult";
    }
