...
import com.yuanzheng.common.dao.DictDao;
...
public class DictServiceImpl implements DictService {
    ...
    public String getValue(String type, String name) {
        ...
        param.put("type", type);
        param.put("name", name);
        String rString = dictDao.list(param).get(0).getValue();
        return rString;
    }
    ...
    @Override
    public List<DictDO> listExit(Map<String, Object> params) {
        return dictDao.listExit(params);
    }
