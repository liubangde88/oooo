package com.yuanzheng.common.redis.shiro;
...
public class RedisManager {
    ...
    public String setStrExpire(String key, String value, int expireTime) {
        Jedis jedis = jedisPool.getResource();
        try {
            jedis.set(key, value);
            if (expireTime != 0) {
    ...
    public String setPStr(String key, String value) {
        Jedis jedis = jedisPool.getResource();
        try {
            jedis.set(key, value);
