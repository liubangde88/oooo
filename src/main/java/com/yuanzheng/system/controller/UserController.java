...
public class UserController extends BaseController {
    ...
    @GetMapping("/listChannelOwner")
    @ResponseBody
    List<UserDO> listChannelOwner(@RequestParam Map<String, Object> params) {
        // 查询列表数据
        params.put("deptId", 16);
    ...
    String selectUser(Model model, @PathVariable("deptId") Long deptId) {
    ...
    @ResponseBody
    @GetMapping("/list/select/{deptId}")
    public List<UserDO> selectlist(@PathVariable("deptId") Long deptId) {
        // 查询列表数据
        List<UserDO> usl = userService.selectListByDept(deptId);
        return usl;
    }
    ...
    public List<UserDO> allList() {
        List<UserDO> usl = userService.allList();
        return usl;
    }
}
